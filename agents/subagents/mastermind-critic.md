...
The planner (running [`mastermind-task-planning`](../../skills/workflow/mastermind-task-planning/SKILL.md)) spawns me during **Step 4 — design-time challenge**, AFTER they have a design and BEFORE they draft the spec.
...
- **Alternatives considered** — what was on the table and why others were rejected (the planner must enumerate ≥ 2 alternatives in non-trivial cases — see [`mastermind-task-planning`](../../skills/workflow/mastermind-task-planning/SKILL.md))
...
- Spawned by [`mastermind-task-planning`](../../skills/workflow/mastermind-task-planning/SKILL.md)
