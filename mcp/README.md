...
|---|---|---|
| [`mmcg`](servers/mmcg/README.md) | stdio | 32 bounded tools over a local SQLite index: 21 refreshable non-destructive queries, 10 read-only queries, and one additive scratchpad write |
