...
|---|---|---|
| [`senior-eng-review`](workflow/senior-eng-review.md) | system | Staff-engineer framing for PR reviews — operational risk first, line style last. Used by the planner during the review phase. |
| [`api-shape-explorer`](workflow/api-shape-explorer.md) | user | Generates 3 radically different API shapes for a given problem so you can compare tradeoffs. Used by the planner during brainstorming. |
