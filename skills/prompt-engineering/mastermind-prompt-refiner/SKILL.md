...
The runtime companion is the [`mastermind-prompt-refiner` subagent](../../../agents/subagents/mastermind-prompt-refiner.md). Mounted as an optional preprocessor in the [`mastermind-workflow`](../../../agents/claude-md/mastermind-workflow.md) CLAUDE.md.
