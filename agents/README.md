...
| [`mastermind-task-executor`](subagents/mastermind-task-executor.md) | Executes a `.mastermind/tasks/<NNN>-<name>/spec.md` file produced by the Mastermind planner. Pair with the [`mastermind-workflow`](claude-md/mastermind-workflow.md) CLAUDE.md template. |
