...
remain visible without becoming risk claims. The bounded audit card orders
errors and warnings ahead of informational results, so its six visible rows do
not hide a later severe finding.
