...
- Companion: pair with [`skills/code-review/pr-review`](../../../skills/code-review/pr-review/SKILL.md) when reviewing PRs that reference files outside the working directory.
