...
changed-file scope boundary. It deliberately contains no path samples: use the
bounded `changes.files` collection for those. Classification routes follow-up
